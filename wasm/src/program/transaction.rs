...
mod tests {
  ...
  _nonce: 1635890755607797813652478911794003479783620859881520791852904112255813473142group.public
    ...
    fn test_build_transaction() {
        ...
        let transfer_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources-backup/transfer.prover.837ad21");
        let transfer_bytes = transfer_buffer.to_vec();
        ParameterProvider::store_bytes("TransferProver".into(), transfer_buffer.to_vec());
        let transfer_v_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources-backup/transfer.verifier.db46e4c");
        ParameterProvider::store_bytes("TransferVerifier".into(), transfer_v_buffer.to_vec());
        let inclusion_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources-backup/inclusion.prover.b9921c5");
        ParameterProvider::store_bytes("InclusionProver".into(), inclusion_buffer.to_vec());
        let inclusion_v_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources-backup/inclusion.verifier.3f4d6b7");
