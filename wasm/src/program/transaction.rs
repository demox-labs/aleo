...
use crate::{
    ...
    types::{
        ...
        StatePathNative,
        StateRootNative,
        TransactionNative, IdentifierNative
    }
};
...
impl TransactionBuilder {
    ...
    pub fn verify_transaction(
        ...
        match transaction {
            TransactionNative::Deploy(_, _, _) => {
...
mod tests {
    ...
    fn test_build_transaction() {
        ...
        let inclusion_bytes = include_bytes!(concat!(env!("HOME"), "/.aleo/resources/inclusion.prover.b9921c5")).to_vec();
