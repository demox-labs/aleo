...
impl TransactionBuilder {
    ...
    pub fn build_transfer_full(
        ...
        let process = Process::load_transfer().unwrap();
...
mod tests {
  ...
  _nonce: 1635890755607797813652478911794003479783620859881520791852904112255813473142group.public
    ...
    //     // let mint_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/mint.prover.6b3b2b0");
    //     // ParameterProvider::store_bytes("MintProver".into(), mint_buffer.to_vec());
    //     let transfer_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/transfer.prover.837ad21");
    //     let transfer_bytes = transfer_buffer.to_vec();
    //     ParameterProvider::store_bytes("TransferProver".into(), transfer_buffer.to_vec());
    //     for i in 0..100 {
    //         println!("Element {}: {}", i, transfer_bytes[i]);
    //     }
    //     let transfer_v_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/transfer.verifier.db46e4c");
    //     ParameterProvider::store_bytes("TransferVerifier".into(), transfer_v_buffer.to_vec());
    //     let inclusion_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/inclusion.prover.b9921c5");
    //     ParameterProvider::store_bytes("InclusionProver".into(), inclusion_buffer.to_vec());
    //     let inclusion_v_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/inclusion.verifier.3f4d6b7");
    //     ParameterProvider::store_bytes("InclusionVerifier".into(), inclusion_v_buffer.to_vec());
    //     // let join_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/join.prover.369fac2");
    //     // ParameterProvider::store_bytes("JoinProver".into(), join_buffer.to_vec());
    //     // let split_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/split.prover.8713930");
    //     // ParameterProvider::store_bytes("SplitProver".into(), split_buffer.to_vec());
    //     // let fee_buffer = include_bytes!("/Users/evanmarshall/.aleo/resources/fee.prover.0a31a56");
    //     // ParameterProvider::store_bytes("FeeProver".into(), fee_buffer.to_vec());
