...
impl VerifyingKey {
    ...
    pub fn bond_public_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::BondPublicVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn claim_unbond_public_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::ClaimUnbondPublicVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn fee_private_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::FeePrivateVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn fee_public_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::FeePublicVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn inclusion_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::InclusionVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn join_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::JoinVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn set_validator_state_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::SetValidatorStateVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn split_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::SplitVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn transfer_private_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPrivateVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn transfer_private_to_public_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPrivateToPublicVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn transfer_public_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPublicVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn transfer_public_to_private_verifier() -> VerifyingKey {
        VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPublicToPrivateVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_bond_public_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::BondPublicVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_claim_unbond_public_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(
            &snarkvm_parameters::mainnet::ClaimUnbondPublicVerifier::load_bytes().unwrap(),
        )
        .unwrap()
    }
    ...
    pub fn is_fee_private_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::FeePrivateVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_fee_public_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::FeePublicVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_inclusion_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::InclusionVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_join_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::JoinVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn is_set_validator_state_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(
            &snarkvm_parameters::mainnet::SetValidatorStateVerifier::load_bytes().unwrap(),
        )
        .unwrap()
    }
    ...
    pub fn is_split_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::SplitVerifier::load_bytes().unwrap()).unwrap()
    }
    ...
    pub fn is_transfer_private_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPrivateVerifier::load_bytes().unwrap())
            .unwrap()
    }
    ...
    pub fn is_transfer_private_to_public_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(
            &snarkvm_parameters::mainnet::TransferPrivateToPublicVerifier::load_bytes().unwrap(),
        )
        .unwrap()
    }
    ...
    pub fn is_transfer_public_verifier(&self) -> bool {
        self == &VerifyingKey::from_bytes(&snarkvm_parameters::mainnet::TransferPublicVerifier::load_bytes().unwrap())
            .unwrap()
    }
